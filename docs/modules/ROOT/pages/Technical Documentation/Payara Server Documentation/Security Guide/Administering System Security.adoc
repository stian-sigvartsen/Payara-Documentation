...
For more information about configuring behind-proxy mode and other HTTP options, see xref:../general-administration/administering-http-connectivity.adoc#protocol-configuration[Protocol Configuration in the Administration Guide].
