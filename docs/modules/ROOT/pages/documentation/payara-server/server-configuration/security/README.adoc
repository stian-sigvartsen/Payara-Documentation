...
For more information about configuring behind-proxy mode and other HTTP options, see xref:documentation/payara-server/server-configuration/http/protocols/http-options.adoc#configuration-http-behind-proxy[Behind Proxy in HTTP Options].
